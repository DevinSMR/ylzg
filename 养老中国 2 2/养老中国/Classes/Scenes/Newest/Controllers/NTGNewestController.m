...
@interface NTGNewestController ()<UITableViewDelegate,UITableViewDataSource,NJBannerViewDataSource,UISearchBarDelegate>
...
@implementation NTGNewestController
...
-(void)requestCycleViewData{
    ...
    if ([NTGDetection netStatus] == NotReachable) {
        ...
        [NTGSendRequest getLastestBanner:nil success:result2];
    }
