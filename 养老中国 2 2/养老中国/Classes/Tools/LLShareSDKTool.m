...
//分享功能
static NSString *const ShareAppKey = @"170d6b275e73c";

//微信开放平台,申请地址:https://open.weixin.qq.com/
static NSString *const WXShareAppID = @"wxcd83983825e2a30d";
static NSString *const WXShareAppSecret = @"aec4fd56878c66614b14bc42fc128ff1";

//新浪分享:申请地址http://open.weibo.com/apps/192207424/info/basic
static NSString *const SinaShareAppKey = @"1439996657";
static NSString *const SinaShareAppSecret = @"4efed5c3aa81b3191148af78bd75909a";
static NSString *const SinaOAuthWebAddress = @"https://api.weibo.com/oauth2/default.html";

//腾讯开发者开发者平台,申请地址:http://open.qq.com/
static NSString *const QQShareAppID = @"1105791320";
static NSString *const QQShareAppSecret = @"AJqT16edCWIucska";
...
+(void)registerShare
{
    ...
    //  ,@(SSDKPlatformTypeQQ),@(SSDKPlatformTypeSinaWeibo)
